...
--@Descripción: Creación de sinónimos para el nodo ensbdd_s2 (Este)

-- SUCURSAL
create or replace synonym sucursal_f1 for sucursal_f1_ens_s1@ensbdd_s1;
create or replace synonym sucursal_f2 for sucursal_f2_ens_s2;
...
create or replace synonym sucursal_taller_f2 for sucursal_taller_f2_ens_s2;
...
create or replace synonym sucursal_venta_f2 for sucursal_venta_f2_ens_s2;
...
create or replace synonym servicio_laptop_f2 for servicio_laptop_f2_ens_s2;
...
create or replace synonym laptop_f4 for laptop_f4_ens_s2;
...
create or replace synonym historico_status_laptop_f1 for historico_status_laptop_f1_ens_s2;
