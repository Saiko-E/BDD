...
--@Descripción: Creación de sinónimos para el nodo aadbdd_s2 (Sur)
...
create or replace synonym sucursal_f4 for sucursal_f4_aad_s2;
...
create or replace synonym sucursal_taller_f4 for sucursal_taller_f4_aad_s2;
...
create or replace synonym sucursal_venta_f4 for sucursal_venta_f4_aad_s2;
...
create or replace synonym servicio_laptop_f4 for servicio_laptop_f4_aad_s2;

-- LAPTOP
create or replace synonym laptop_f1 for laptop_f1_ens_s1@ensbdd_s1;
create or replace synonym laptop_f2 for laptop_f2_aad_s2;
...
create or replace synonym laptop_f5 for laptop_f5_aad_s2;
...
create or replace synonym tipo_almacenamiento_r4 for tipo_almacenamiento_r@aadbdd_s1;
...
create or replace synonym tipo_monitor_r4 for tipo_monitor_r@aadbdd_s1;
...
create or replace synonym tipo_procesador_r4 for tipo_procesador_r@aadbdd_s1;
...
create or replace synonym tipo_tarjeta_video_r4 for tipo_tarjeta_video_r@aadbdd_s1;