...
--@Descripción: Vistas con acceso a datos BLOB para el nodo ensbdd_s2 (Este)
...
prompt Creando vista SERVICIO_LAPTOP (FACTURA F2 es local)
...
union all
select num_servicio, sucursal_id, laptop_id, diagnostico, importe, factura from servicio_laptop_f2
union all
