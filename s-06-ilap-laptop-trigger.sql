...
begin
    case
        when inserting then
            ...
            /* 2. Manejo de BLOB: Inserción Vertical Remota en el Sur (F5) */
            insert into ti_laptop_f5(laptop_id, foto) values (:new.laptop_id, :new.foto);
            insert into laptop_f5(laptop_id, foto) select laptop_id, foto from ti_laptop_f5 where laptop_id = :new.laptop_id;
